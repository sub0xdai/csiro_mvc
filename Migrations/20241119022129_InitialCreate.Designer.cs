...
namespace csiro_mvc.Migrations
{
    ...
    [Migration("20241119022129_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("csiro_mvc.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("csiro_mvc.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("csiro_mvc.Models.Application", b =>
                {
                    b.HasOne("csiro_mvc.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
